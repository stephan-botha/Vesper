...
public class AutopopulateSceneNames : AssetPostprocessor
{
    ...
    static void ConfigureRiftBuild()
    {
    ...
    static void ConfigureGearVRBuild()
    {
    ...
    // Congigure a build for Gear VR without a Gamepad
    ...
    static void ConfigureJustThisScene()
    {
        ...
        finalStringList.Add(EditorApplication.currentScene);
